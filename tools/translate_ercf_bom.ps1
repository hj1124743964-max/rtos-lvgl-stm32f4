$src = 'C:\Users\Administrator\Desktop\ERCF v2 (RC1 Draft) Community Edition BOM and Sourcing Guide.xlsx'
$outDir = 'E:\rtos_lvgl_machine\translated'
$out = Join-Path $outDir 'ERCF_v2_RC1_BOM_中文翻译.xlsx'
$translationFile = 'E:\rtos_lvgl_machine\tools\ercf_translations.tsv'
